...
from aiogram.utils.formatting import as_list, as_line, Pre, Bold, Code
    ...
    while True:
        ...
        if len(app_results) == 0:
            ...
            for node_name in app_results:
                if app_results[node_name]['last_status'] == True: node_status = "🌿 Online"
        ...
        t = as_list(
            "⏲ Heartbeat message:", "",
            *heartbeat_list,
            f"⏳ Heartbeat schedule: every {app_config['service']['heartbeat_period_hours']} hours")
